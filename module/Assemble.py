...
def read_step_file_with_names_colors(filename):
    ...
    def _get_sub_shapes(lab, loc):
        ...
        #print("DumpToString   :", shape_tool.DumpToString())#获取装配关系
...
def analyse(assemble_relation_list):#获取每个零件装配属性
...
def Get_assemble_relation(DumpToString="",assemble_relation_list=""):#获取整个part 装配关系
