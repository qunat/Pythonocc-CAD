    ...
    def Import_machine_model(self):  # 导入机床模型
        ...
        try:
            try:
                ...
                self.show_Machine_spindle_shape = self.canva._display.DisplayShape(self.Machine_spindle_shape,
                                                                                   color="WHITE", update=True)
                self.show_Machine_work_table = self.canva._display.DisplayShape(self.Machine_work_table, color="WHITE",
                                                                                update=True)
                # 主轴移动到安全距离
