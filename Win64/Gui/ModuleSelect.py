...
class moduleselect(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./Images/Pic/model-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./Images/Pic/assembly-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("./Images/Pic/sheet-removebg-preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
