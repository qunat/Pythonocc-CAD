...
from Win64.Ribbon.SketcherButton import SketcherButton
...
class SketcherWidget(QtWidgets.QMainWindow):
	...
	def setupUi(self,parent):
		...
		icon = QtGui.QIcon()
		icon.addPixmap(QtGui.QPixmap("./Win64/icons/{}.png".format("矩形1")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		...
		self.pushbutton_ok = QtWidgets.QPushButton()
		icon = QtGui.QIcon()
		icon.addPixmap(QtGui.QPixmap("./Win64/icons/{}.png".format("矩形2")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.pushbutton_ok.setIcon(icon)
		...
		icon = QtGui.QIcon()
		icon.addPixmap(QtGui.QPixmap("./Win64/icons/{}.png".format("矩形3")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
		self.pushbutton_ok.setIcon(icon)
		self.pushbutton_ok.setIconSize(QtCore.QSize(30, 30))
		HBOX_button.addWidget(self.pushbutton_ok)
